...
void Wrapper::SelectComponentsForBackup(
...
// Select the maximum number of components such that their 
// file descriptors are pointing only to volumes to be shadow copied
void Wrapper::SelectComponentsForRestore(
        vector<wstring> excludedWriterAndComponentList,
        vector<wstring> includedWriterAndComponentList
        )
{
...
void Wrapper::DiscoverDirectlyExcludedComponents(
    vector<wstring> excludedWriterAndComponentList,
...
void Wrapper::ExcludeWritersWithNoRestoreEvents()
{
    FunctionTracer ft(DBG_INFO);
...
void Wrapper::DiscoverNonShadowedExcludedComponents(
    vector<wstring> shadowSourceVolumes
)
{
    FunctionTracer ft(DBG_INFO);
...
void Wrapper::DiscoverAllExcludedComponents()
{
    FunctionTracer ft(DBG_INFO);
...
// - either have a top-level nonselectable excluded component
// - or do not have any included components (all its components are excluded)
void Wrapper::DiscoverExcludedWriters()
{
    FunctionTracer ft(DBG_INFO);
...
void Wrapper::DiscoverExplicitelyIncludedComponents()
{
    FunctionTracer ft(DBG_INFO);
...
void Wrapper::VerifyExplicitelyIncludedComponent(
...
void Wrapper::VerifyExplicitelyIncludedWriter(
    wstring writerName,
    vector<VssWriter> & writerList
    )
{
...
// Discover the components that should be explicitly included 
// These are any included top components 
void Wrapper::SelectExplicitelyIncludedComponents()
{
    FunctionTracer ft(DBG_INFO);
...
void Wrapper::SelectNonexcludedComponentsForRestore()
{
    FunctionTracer ft(DBG_INFO);
...
void Wrapper::SetFileRestoreStatus(bool bSuccesfullyRestored)
{
    FunctionTracer ft(DBG_INFO);
...
bool Wrapper::IsWriterSelected(GUID guidInstanceId)
{
...
void Wrapper::CheckSelectedWriterStatus()
{
    FunctionTracer ft(DBG_INFO);
